<x-app-layout>
    ...
    {{-- <form method="POST" action="{{ route('posts.store') }}">
        ...
        <p> Upload Image (Optional): <input type="file" name="uploadedFile" value="{{ old('uploadedFile') }}"> </p>
        <p> <input type="submit" value="Create"> </p> 
        <p> <a href="{{ route('posts.index') }}"> Cancel </a> </p>
        </div>
    </form> --}}
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                ...
                <input
                    ...
                    id="grid-image" type="file" name="uploadedFile" value="{{ old('uploadedFile') }}">
            </div>
        </div>
        <div class="flex flex-wrap -mx-3 mb-6">
            <div class="w-full h-full px-3">
                ...
                <textarea
                    ...
                    id="grid-content" placeholder="Example Content" name="content"
